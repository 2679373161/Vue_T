...
<el-table  ref="tableRef" :data="tableData" height="900px" border style="width: 100%;margin-top:20px" align="center">
    ...
    <el-table-column  prop="fault_type" align="center" width='120px' label="故障类型"></el-table-column>
       <el-table-column  prop="total_num" align="center" width='210px' label="参与统计是否熄火的片段总数"></el-table-column> 
    <el-table-column  prop="flameout_num" align="center" width='150px' label="熄火片段数"></el-table-column>
   <el-table-column   prop="max_flameout_count" align="center" width='150px' label="片段最大熄火次数"></el-table-column>
...
//改进
 ...
 window.open(routeData.href);
  ...
  const dt  = new Date();
  var sj
  dt.setTime(dt.getTime()-86400000*14);//一天是86400000


  sj=this.dateFormat(dt);  //14天前的时间
...
  this.temp_currentPage=1
    ...
    request.post('fault/page/faultsummaries', null, {
      params:
           { 
          flag: 1,
 ...
 if (response.data.data==""){
        ...
        for(var i=0;i<response.data.data.length;i++){
          ...
          time_date:sj+"-"+response.data.data[i].time_date,

          }
        }
               for(var i=0;i<response.data.data.length;i++){
        
            this.tableData[i].fault_type="熄火异常"

...
<div class="mytable">
<!--tableData熄火指标flag=1-->
<el-table ref="tableRef" :data="tableData"  :cell-style="cellStyle"  max-height="900" border style="width: 100%;margin-top:20px" align="center">
...
console.log(this.temp_currentPage)
    request.post('faultstatistics/page/equfaultnum', null, {
      params:
           { 
...
//this.shijian=this.$route.query.time//接收到的日期时间，需转换为时间戳再减去13天的时间戳，再转换为日期
 ...
 if(this.$route.query.type!=null){
  ...
  this.datatime[1]=this.dateFormat(this.$route.query.time1);  //点击的日期;  //点击的日期

...
<el-table  ref="tableRef" :data="tableData" :cell-style="cellStyle"  height="900px" border style="width: 100%;margin-top:20px" align="center">
    ...
    <el-table-column  prop="start_time" align="center"  label="采集开始时间"></el-table-column>
      <el-table-column  prop="end_time" align="center"  label="采集结束时间"></el-table-column>
    ...
    <el-table-column   prop="e1" align="center"  label="意外熄火E1"></el-table-column>
   ...
   <el-table-column  v-if="this.sumf2!=0" prop="f2" align="center"  label="进水温度传感器故障F2"></el-table-column>
    ...
    <el-table-column  prop="c4" align="center"  label="风堵故障C4"></el-table-column>
...
console.log(this.temp_currentPage)
    request.post('recording/page/idfault', null, {
      params:
           { 
...
    return year+"-"+month+"-"+day;
    ...
    handleSelect() {
      ...
      if (this.value2.length == 0) {//型号空时
        ...
        request.post('recording/page/getequ', null, {
          params:
          { 
            type: this.value2
          },
  ...
  created() {
     request.post('recording/page/gettype', null, {
         params:
         { 

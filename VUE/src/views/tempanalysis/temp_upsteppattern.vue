...
    </el-date-picker>
    ...
    <el-select v-model="value"  @change="Changestate" style="width:150px; margin-right:30px;" placeholder="请选择" >
      ...
      <div id="map"></div>
      <el-table :data="tableData1" border style="width: 100%" align="center"  :row-class-name="tableRowClassName1" :cell-style="cellStyle" :default-sort = "{prop: 'un_stable_proportion', order: 'descending'}">

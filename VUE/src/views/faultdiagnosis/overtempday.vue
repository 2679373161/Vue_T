...
<div>
<!--tableData超温flag=1-->
<el-table v-if="this.flag==1" ref="tableRef" :data="tableData" height="900px" border style="width: 100%;margin-top:20px" align="center">
    <el-table-column  type="index"  align="center" width='60px' label="序号" :index="indexMethod"></el-table-column>
    <el-table-column  prop="time_date" align="center" width='120px' label="时间"></el-table-column>
    <el-table-column  prop="province" align="center" width='80px' label="省份"></el-table-column>
    ...
    <el-table-column  prop="fault_type" align="center" width='150px' label="故障类型"></el-table-column>
    <el-table-column  prop="total_num" align="center" width='210px' label="参与统计是否超温的片段总数"></el-table-column> 
    <el-table-column  prop="over_temp_num" align="center" width='120px' label="超温总片段数"></el-table-column>
    <el-table-column   prop="abnormal_num" align="center" width='150px' label="正常情况超温片段数"></el-table-column>
    <el-table-column   prop="flow_num" align="center" width='150px' label="水流波动超温片段数"></el-table-column>
    <el-table-column   prop="intemp_num" align="center" width='150px' label="进水温度异常超温片段数"></el-table-column>
    <el-table-column   prop="min_load_num" align="center" width='150px' label="最小工况超温片段数"></el-table-column>
    <el-table-column   prop="avg_over_temp" align="center" width='120px' label="平均超温值℃"></el-table-column>
    <el-table-column  v-if="false" prop="city_code" align="center" width='100px' label="城市编号"></el-table-column>
  <el-table-column
      label="操作1"
      align="center">
...
export default {
 ...
 json_fields: {
      ...
      "故障类型":'fault_type',
      "参与统计是否超温的片段总数":'total_num',
      "超温片段总数":'over_temp_num',
      "正常情况超温片段数":'abnormal_num',
      "水流波动超温片段数":'flow_num',
      "进水温度异常超温片段数":'intemp_num',
      "最小工况超温片段数":'min_load_num',
      "平均超温值℃":'avg_over_temp',
    },
    fanye:0,
    flag:"1",
...
  this.temp_currentPage=1
      ...
      this.tableData=[]
      this.total=0
    request.post('fault/page/overtempday', null, {
      params:
        { 
        ...
        for(var i=0;i<response.data.data.length;i++){
          console.log(response.data.data[i].fault_code)
          if (response.data.data[i].fault_code=="NE4"){
            this.tableData[i].fault_type="正常情况超温"
          }else if(response.data.data[i].fault_code=="NE4a"){
            this.tableData[i].fault_type="水流波动超温"
          }else if(response.data.data[i].fault_code=="NE4b"){
            this.tableData[i].fault_type="进水温度异常超温"
          }else if(response.data.data[i].fault_code=="NE4c"){
            this.tableData[i].fault_type="最小工况超温"
          }
            this.tableData[i].province=response.data.data1[i].dev_province
            this.tableData[i].dev_city=response.data.data1[i].dev_city
            this.tableData[i].city_code=response.data.data[i].city_code
...
      this.fanye=0
       ...
       this.value2 = []
       this.value3 = []
       request.post('fault/page/overtempdaygettype', null, {
        params:
          { 
...
request.post('fault/page/overtempdaygettype', null, {
    ...
    handleSelect() {
      ...
      if (this.value2.length == 0) {//型号空时
        ...
        request.post('fault/page/overtempdaygetid', null, {
          params:
          { 
            flag: shebeiflag,
            province_code: this.value[0],
...
this.shijian=this.$route.query.time//接收到的日期时间，需转换为时间戳再减去13天的时间戳，再转换为日期
  ...
  this.value=[city,this.$route.query.city]
     ...
     request.post('fault/page/overtempdaygetdata', null, {
         params:
         { 
         },
       }).then(({ data: response }) => {

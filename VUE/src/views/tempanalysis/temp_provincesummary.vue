...
export default {
  ...
  { 
    ...
    changeTrendorder(){
      // this.abnormal_stable_temp_pro=[];
      // this.province=[];
      var conditon=[];
      lengend1={'恒温异常模式占比':false,'不恒温时长占比':false,'加热时长/台':false,'不恒温时长/台':false,'加热+恒温异常模式占比':false,'温度有效片段':false}
      switch(this.value1){
    ...
    search(){
      ...
      request.post('tableStoreDates/page/list', null, {
        ...
        // abnormal_stable_temp_pro=response.data.abnormal_stable_temp_pro;
